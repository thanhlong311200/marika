module.exports = {
  get: {
    tags: ['Recipes'],
    summary: "get list recipes (by User & Admin)",
    operationId: 'GetListRecipes',
    parameters: [
      {
        name: 'name',
        in: 'query',
        description: "name of recipes. eg: name=eggs on toast",
        schema: {
          type: 'string',
        }
      },
      {
        name: 'typeId',
        in: 'query',
        description: "typeId of recipes. eg: typeId=61cc5a72dc50a2ef90b91302",
        schema: {
          type: 'string',
        }
      },
      {
        name: 'tags',
        in: 'query',
        description: "tag of recipes. eg: tags=61cc55e187a64b5da0aa9894&tags=61ccc24535e0093778f311f7",
        schema: {
          type: 'array',
        }
      },
      {
        name: 'mealId',
        in: 'query',
        description: "mealId of recipes. eg: mealId=61cc5ea8dc50a2ef90b9132f",
        schema: {
          type: 'string',
        }
      },
      {
        name: 'dietaryId',
        in: 'query',
        description: "dietaryId of recipes. eg: dietaryId=61ccb63096d0afe3106a03ef",
        schema: {
          type: 'string',
        }
      },
      {
        name: 'categoryId',
        in: 'query',
        description: "categoryId of recipes. eg: categoryId=61cc5df3dc50a2ef90b9131a",
        schema: {
          type: 'string',
        }
      },
      {
        name: 'ingredients',
        in: 'query',
        description: "ingredients of recipes. eg: ingredients=61cc55e187a64b5da0aa9894&ingredients=61ccc24535e0093778f311f7",
        schema: {
          type: 'array',
        }
      },
