module.exports = {
  put: {
    tags: ['Media'],
    summary: "update media by id (by Admin)",
    operationId: 'changeMedia',
    parameters: [{
      name: 'id',
      in: 'path',
      description: "mediaId you want to update, id: 61cb374eba7d0a061825551f",
      required: true,
      schema: {
        type: 'string',
      }
    ...
    responses: {
      '200': {
        description: "Handler media success",
        content: {
          'application/json': {
            schema: {
              type: 'object',
      ...
      '400': {
        description: "Handler media Fail !",
        content: {
          'application/json': {
            schema: {
