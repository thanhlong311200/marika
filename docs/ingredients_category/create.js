module.exports = {
  post: {
    ...
    summary: "create ingredients category (by Admin)",
    operationId: 'createIngredientsCategory',
    security: [{
      bearerAuth: []
    }],
    requestBody: {
    ...
    responses: {
      '200': {
        description: "Create ingredients category success",
        content: {
          'application/json': {
            schema: {
              type: 'object',
      ...
      '400': {
        description: "Create ingredients category Fail !",
        content: {
          'application/json': {
            schema: {
